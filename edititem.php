...
<input type="hidden" name="id" value="<?php echo $dnn["id"];?>" readonly><br>
...
แท็ก: <input type="text" name="data" value="<?php echo $dnn["data"];?>"><br>
ไฟล์ที่อับโหลด: <input type="text" name="downloadurl" value="<?php echo $dnn["downloadurl"];?>" readonly>
